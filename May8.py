...
class Window1(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.input_neurons_edit.setFixedWidth(300)  # 设置宽度为100像素
    ...
    def train_model(self):
        ...
        # 训练模型
        history = self.model.fit(self.x_train, self.y_train, epochs=self.para_iter, verbose=0)

        #self.update_labels_and_plots(history)
    ...
    def pass_para(self, activ, optm, iter):
...
class Window_Para(QtWidgets.QDialog):
    ...
    def confirm(self):
        ...
        self.accept()  # 关闭子窗口
        self.parent().pass_para(activ, optm, iter)
